...
public class GrapheSimpleTest extends GrapheSimple
{
    ...
    int distance_s1_s3 = 1;
    int distance_s1_s4 = 2;
    int distance_s2_s3 = 1;
    int distance_s3_s4 = 2;
    int distance_s4_s1 = 10;
    int distance_s2_s4 = 1;
    int distance_s2_s5 = 2;
    int distance_s4_s3 = 2;
    int distance_s4_s5 = 2;
    ...
    public void initGlobalGraph ()
    {
        ...
        graphe.ajouterArc(s1, s4, distance_s1_s4);
        graphe.ajouterArc(s2, s3, distance_s2_s3);
        graphe.ajouterArc(s3, s4, distance_s3_s4);
        graphe.ajouterArc(s4, s1, distance_s4_s1);
        graphe.ajouterArc(s2, s4, distance_s2_s4);
        graphe.ajouterArc(s2, s5, distance_s2_s5);
        graphe.ajouterArc(s4, s3, distance_s4_s3);
        graphe.ajouterArc(s4, s5, distance_s4_s5);
    ...
    public void testVoisinsSommet ()
    {
        ...
        assertEquals("voisins de s2 : " + voisins, 3, voisins.size());
    ...
    public void testCheminLePlusCourt ()
    {
        ...
        assertEquals(2, chemin.distance());
    ...
    public void testVoisinsDeRangs ()
    {
        ...
        assertEquals(1, voisins.size());
        assertTrue(voisins.contains(s5));
